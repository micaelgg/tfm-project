...
if __name__ == '__main__':
    ...
    dataset = Dataset(path_dataset, name_dataset, emotions, number_emo)
    name_save_dataset = name_dataset + '-' + ''.join(str(e) for e in number_emo)
    path_save_dataset = name_save_dataset + "/" + name_save_dataset

    # source: https://thispointer.com/how-to-create-a-directory-in-python/
    # Create target directory & all intermediate directories if don't exists
    try:
        os.makedirs(name_save_dataset)
        print("Directory ", name_save_dataset, " Created ")
    except FileExistsError:
        print("Directory ", name_save_dataset, " already exists")
